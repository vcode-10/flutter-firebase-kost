import '../light_real_estate_details_full_page_screen/widgets/autolayouthorizontal6_item_widget.dart';
...
class LightRealEstateDetailsFullPageScreen
    extends GetWidget<LightRealEstateDetailsFullPageController> {
  const LightRealEstateDetailsFullPageScreen({Key? key}) : super(key: key);
                        ...
                        child: Column(children: [
                          ...
                          Align(
                              ...
                              child: Padding(
                                  ...
                                  child: Text("msg_modernica_apartment".tr,
                          ...
                          Align(
                              ...
                              child: Padding(
                                  padding:
                                      EdgeInsets.only(left: 24.h, right: 64.h),
                                  child: Row(children: [
                                    CustomIconButton(
                                        height: 40.adaptSize,
                                        width: 40.adaptSize,
                                        ...
                                        decoration:
                                            IconButtonStyleHelper.fillBlueTL20,
                          ...
                          Align(
                              ...
                              child: Padding(
                                  padding:
                                      EdgeInsets.only(left: 24.h, right: 99.h),
                                  child: Row(children: [
                                    CustomImageView(
                                        imagePath:
                                            ImageConstant.imgIconlyBoldLocation,
                                        height: 20.adaptSize,
                                        width: 20.adaptSize),
                                    Padding(
                                        padding: EdgeInsets.only(
  ...
  Widget _buildAutoLayoutHorizontal3() {
    return SizedBox(
        ...
        child: Obx(() => ListView.separated(
            ...
            itemCount: controller.lightRealEstateDetailsFullPageModelObj.value
                .autolayouthorizontal6ItemList.value.length,
            itemBuilder: (context, index) {
              Autolayouthorizontal6ItemModel model = controller
                  .lightRealEstateDetailsFullPageModelObj
                  .value
                  .autolayouthorizontal6ItemList
                  .value[index];
              return Autolayouthorizontal6ItemWidget(model);
            })));
  }
